...
public class NoiseBasedChunkGeneratorMixin {
	...
	private static Aquifer.FluidPicker createFluidPicker(NoiseGeneratorSettings pSettings) {
		Aquifer.FluidStatus aquifer$fluidstatus = new Aquifer.FluidStatus(-480, Blocks.LAVA.defaultBlockState());
		...
		return (p_224274_, p_224275_, p_224276_) -> {
			return p_224275_ < Math.min(-480, i) ? aquifer$fluidstatus : aquifer$fluidstatus1;
		};
	}
